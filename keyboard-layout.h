...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_miryoku(
    KC_Q,              KC_W,              KC_E,              KC_R,              OSL(NUM),              KC_Y,              KC_U,               KC_I,              KC_O,             KC_P,
    LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      RGUI_T(_OE),
    KC_Z,              ALGR_T(KC_X),      MY_PREV, 		     KC_V,              KC_B,              KC_N,              KC_M,              QK_LEAD,           _AA,               _AE,
    U_NP,              U_NP,              OSM(MOD_LALT),  LT(NAV, KC_SPC),   LT(MOUSE, KC_DOT), LT(FUN, KC_ENT),   LT(NUM, KC_BSPC),  OSL(SYM),          U_NP,              U_NP
  ),
  [NAV] = LAYOUT_miryoku(
  ...
  [NUM] = LAYOUT_miryoku(
    ...
    U_NP,    U_NP,    U_NA,    KC_SPC, KC_DOT,  U_NA,    TG(NUM), U_NA,    U_NP,    U_NP
  ),
  [SYM] = LAYOUT_miryoku(
